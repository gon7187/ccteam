...
- **Workflow → Evolution** — accept or revise a completed answer, attach concrete feedback, and ask the same session for an improvement proposal that cannot apply itself without your approval. The canonical verdict journal survives rebuilds and rotation; the dashboard keeps accepted/revised/unrated, outcome, duration, pricing coverage, and spawn-time role/skill attribution explicit, with missing facts shown as unknown rather than zero
